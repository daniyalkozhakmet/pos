...
var CategoryRepository = /** @class */ (function () {
    ...
    CategoryRepository.prototype.CreateCategory = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var newCategory, categoryResult;
            var name = _b.name;
    ...
    CategoryRepository.prototype.GetCategories = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var totalDocuments, totalPages, skip, exsitingCategories;
            var limit = _b.limit, page = _b.page;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, Category_1.default.countDocuments()];
                    case 1:
    ...
    CategoryRepository.prototype.GetCategoryById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var exsitingCategory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        exsitingCategory = _a.sent();
                        if (!exsitingCategory) {
                            throw new app_errors_1.NotFoundError("Category not found");
                        }
    ...
    CategoryRepository.prototype.UpdateCategory = function (id_1, _a) {
        return __awaiter(this, arguments, void 0, function (id, _b) {
            var exsitingCategory, existedShop;
            var name = _b.name, shop = _b.shop;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.GetCategoryById(id)];
                    case 1:
                        exsitingCategory = _c.sent();
                        if (!shop) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.shopRepository.GetShopById(shop)];
                    case 2:
                        existedShop = _c.sent();
