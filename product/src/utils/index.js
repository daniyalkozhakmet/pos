...
exports.SubscribeMessage = exports.PublishMessage = exports.CreateChannel = exports.FormateData = exports.ValidateSignature = exports.ValidateSignatureRefresh = exports.ValidateSignatureCookie = void 0;
...
var ValidateSignatureCookie = function (req) {
    try {
        ...
        if (token) {
            var decoded = jwt.verify(token, APP_SECRET); // Synchronously verify the token
            req.user = decoded;
...
var ValidateSignatureRefresh = function (req) {
    try {
        ...
        if (token) {
            jwt.verify(token, APP_SECRET); // Synchronously verify the token
            return token;
        }
        return null;
    }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, jwt.verify(signature.split(" ")[1], APP_SECRET)];
            case 1:
                payload = _a.sent();
                req.user = payload;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                channel.bindQueue(q.queue, config_1.EXCHANGE_NAME, config_1.PRODUCT_SERVICE);
