...
exports.default = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var isAuthorized, refresh_token1, service, data, token, refresh_token, decoded;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                refresh_token1 = (0, utils_1.ValidateSignatureRefresh)(req);
                if (!refresh_token1) return [3 /*break*/, 2];
                service = new user_service_1.UserService();
                return [4 /*yield*/, service.RefreshToken(refresh_token1)];
            case 1:
                data = (_a.sent()).data;
