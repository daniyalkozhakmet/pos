...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.CreateUser = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var existing_shop, new_user, userResult;
            var first_name = _b.first_name, last_name = _b.last_name, email = _b.email, address = _b.address, password = _b.password, role = _b.role, salt = _b.salt, shop = _b.shop;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.shopRepository.GetShopById(shop)];
                    case 1:
                        existing_shop = _c.sent();
    ...
    UserRepository.prototype.FindUser = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var existingUser;
            var email = _b.email;
            return __generator(this, function (_c) {
    ...
    UserRepository.prototype.FindUserByShop = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var existingUsers;
            var shop = _b.shop;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, User_1.default.where({ shop: shop })];
                    case 1:
    ...
    UserRepository.prototype.UpdateUser = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            var existingUser, existingShop;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.FindUserById(id)];
                    case 1:
                        existingUser = _a.sent();
                        return [4 /*yield*/, this.shopRepository.GetShopById(data.shop)];
                    case 2:
                        existingShop = _a.sent();
                        console.log({ data: data });
                        if (data.role) {
                            switch (data.role) {
                                case interfaces_1.UserRole.ADMIN:
                                    console.log("ADMIN");
                                    existingUser.role = interfaces_1.UserRole.ADMIN;
                                    break;
                                case interfaces_1.UserRole.USER:
                                    existingUser.role = interfaces_1.UserRole.USER;
                                    break;
                            }
                        }
    ...
    UserRepository.prototype.GetUsers = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var totalDocuments, totalPages, skip, existingUsers;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        existingUser = _a.sent();
                        return [4 /*yield*/, existingUser.deleteOne()];
                    case 2:
                        _a.sent();
