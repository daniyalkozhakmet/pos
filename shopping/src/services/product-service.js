...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.GetProductByBarcodeAndShop = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var existingProduct;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productRepository.GetProductByBarcodeAndShop(data)];
                    case 1:
                        existingProduct = _a.sent();
                        return [2 /*return*/, (0, utils_1.FormateData)(existingProduct)];
                }
            });
        });
    };
    ProductService.prototype.CreateProduct = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productRepository.CreateProduct(data)];
                    case 1:
                        _a.sent();
    ...
    ProductService.prototype.UpdateProduct = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productRepository.UpdateProduct(data)];
                    case 1:
                        _a.sent();
    ...
    ProductService.prototype.DeleteProduct = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productRepository.DeleteProduct(data)];
                    case 1:
                        _a.sent();
